...
/**
 * Represente un son. <br>
 * Les sons les mieux suppoter par Java sont MIDI, AU et certains WAV. <br>
 * Pour savoir si un son est accepte, le seul moyen est d'essayer. <br>
 * Si le son ne sera plus utilise, il faut le detruire par la methode fermer, <br>
 * afin de liberer la memoire et le flux ou se trouve le son. <br>
 * Attention, une fois detruit, le son n'est plus utilisable. <br>
 */
